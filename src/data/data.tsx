...
export const projects: PortfolioProject[] = [
  {
    ...
    images: [
      { src: "/images/business/contact_form.png", alt: "contact form" },
      { src: "/images/business/elevate_business.png", alt: "elevate_business" },
      { src: "/images/business/our_values.png", alt: "our_values" },
      { src: "/images/business/payment_plans.png", alt: "payment" },
      { src: "/images/business/personalized_web_design.png", alt: "personalized_web_design" },
      { src: "/images/business/portfolio_website.png", alt: "portfolio_website" },
      { src: "/images/business/professional_website.png", alt: "professional_website" },
    ],
