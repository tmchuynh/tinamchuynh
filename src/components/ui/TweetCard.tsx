  ...
  <div className="flex flex-1 items-center justify-center">
    {tweet.video && (
      <video
        ...
        muted
        playsInline
        className="rounded-xl border shadow-sm dark:shadow-border"
      >
      ...
      <div className="relative flex transform-gpu snap-x snap-mandatory gap-4 overflow-x-auto">
        ...
        {tweet.photos.map( ( photo ) => (
          <img
            ...
            alt={tweet.text}
            className="h-64 w-5/6 shrink-0 snap-center snap-always rounded-xl border object-cover dark:shadow-border shadow-sm"
          />
        ) )}
        <div className="shrink-0 snap-center sm:w-2" />
      </div>
    ...
    {!tweet.video &&
      ...
      tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
        <img
          ...
          className="h-64 rounded-xl border object-cover shadow-sm dark:shadow-border"
          alt=""
        />
      )}
  </div>
